...
function getchannels() {
    let channeldb = [
        ...
        ["https://video-auth2.iol.pt/live_tvi_ficcao/live_tvi_ficcao/edge_servers/tvificcao-720p/playlist.m3u8", "https://backend-mrdannyarmstrong.github.io/tvneu/v2/banners/tvificcao.svg"],
        ...
        ["https://geo.dailymotion.com/player/xgrus.html?video=kYe5OYErhldJ75Azib2", "https://backend-mrdannyarmstrong.github.io/tvneu/v2/banners/redetv.svg"],
        ...
        ["https://5b33b873179a2.streamlock.net:1443/live/livestream/playlist.m3u8", "https://backend-mrdannyarmstrong.github.io/tvneu/v2/banners/tvcultura.svg"],
        ["https://service-stitcher.clusters.pluto.tv/v1/stitch/embed/hls/channel/5f12136385bccc00070142ed/master.m3u8?advertisingId=channel&appName=rokuchannel&appVersion=1.0&bmodel=bm1&channel_id=channel&content=channel&content_rating=ROKU_ADS_CONTENT_RATING&content_type=livefeed&coppa=false&deviceDNT=1&deviceId=channel&deviceMake=rokuChannel&deviceModel=web&deviceType=rokuChannel&deviceVersion=1.0&embedPartner=rokuChannel&genre=ROKU_ADS_CONTENT_GENRE&is_lat=1&platform=web&rdid=channel&studio_id=viacom&tags=ROKU_CONTENT_TAGS", "https://backend-mrdannyarmstrong.github.io/tvneu/v2/banners/animax.svg"],
        ["NULL", "NULL"],
        ["NULL", "NULL"],
        ["NULL", "NULL"],
        ["NULL", "NULL"]
