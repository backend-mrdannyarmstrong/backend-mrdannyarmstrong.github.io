...
function getchannels() {
    let channeldb = [
        ...
        ["https://video-auth2.iol.pt/live_tvi_ficcao/live_tvi_ficcao/edge_servers/tvificcao-720p/playlist.m3u8", "https://backend-mrdannyarmstrong.github.io/tvneu/v2/banners/tvificcaos.svg"],
        ...
        ["https://5b33b873179a2.streamlock.net:1443/live/livestream/playlist.m3u8", "https://backend-mrdannyarmstrong.github.io/tvneu/v2/banners/tvculture.svg"],
        ["NULL", "NULL"],
        ["NULL", "NULL"],
        ["NULL", "NULL"],
        ["NULL", "NULL"],
